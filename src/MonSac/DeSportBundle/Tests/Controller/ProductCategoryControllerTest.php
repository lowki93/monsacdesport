...
namespace MonSac\DeSportBundle\Tests\Controller;
...
class ProductCategoryControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'monsac_desportbundle_productcategorytype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'monsac_desportbundle_productcategorytype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
